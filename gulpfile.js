...
//****************************************************
gulp.task('top-donation-stats-css', function () {
    return gulp.src('./assets/scss/components/top-donation-stats.scss')
        .pipe(sourcemaps.init())
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(concat('top-donation-stats.min.css'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/css/components'));
});
...
// Hierarchy Style
//****************************************************
gulp.task('hierarchy-css', function () {
    return gulp.src('./assets/scss/components/wpb/hierarchy.scss')
        .pipe(sourcemaps.init())
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(autoprefixer())
        .pipe(concat('hierarchy.min.css'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/css/components/wpb'));
});
...
gulp.task('advanced-search-css', function () {
    return gulp.src('./assets/scss/components/wpb/advanced-search.scss')
        .pipe(sourcemaps.init())
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(concat('advanced-search.min.css'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/css/components/wpb'));
});
...
//****************************************************
// Impact Statistics css
//****************************************************
gulp.task('wpb-impact-statistics-css', function () {
    return gulp.src('./assets/scss/components/wpb/impact-statistics.scss')
        .pipe(sourcemaps.init())
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(concat('impact-statistics.min.css'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/css/components/wpb'));
});
...
// News Carousel css
//****************************************************
gulp.task('wpb-news-carousel-css', function () {
    return gulp.src('./assets/scss/components/wpb/news-carousel.scss')
        .pipe(sourcemaps.init())
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(concat('news-carousel.min.css'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/css/components/wpb'));
});
...
// News Carousel
//****************************************************
gulp.task('wpb-news-carousel-js', function () {
    return gulp.src('./assets/js/components/wpb/news-carousel.js')
        .pipe(sourcemaps.init())
        .pipe(uglify())
        .pipe(concat('news-carousel.min.js'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/js/components/wpb'));
});
...
// Hierarchy Script
//****************************************************
gulp.task('hierarchy-js', function () {
    return gulp.src('./assets/js/components/wpb/hierarchy.js')
        .pipe(sourcemaps.init())
        .pipe(uglify())
        .pipe(concat('hierarchy.min.js'))
        .pipe(sourcemaps.write('./map'))
        .pipe(gulp.dest('./dist/js/components/wpb'));
});
...
gulp.task('components-scripts', gulp.parallel(['wpb-quick-donation-js', 'wpb-primary-carousel-js', 'wpb-zakat-js', 'wpb-vacancies-js', 'wpb-tenders-js', 'wpb-success-story-carousel-js', 'wpb-partners-carousel-js', 'wpb-campaigns-carousel-js', 'wpb-news-carousel-js', 'hierarchy-js', 'events-js']));
