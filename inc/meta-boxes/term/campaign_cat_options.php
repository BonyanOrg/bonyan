...
?>
    <div class="form-field">
        ...
        <input class="upload_video_button button" name="_add_campaign_cover" id="_add_campaign_cover" type="button" value="Select/Upload Image" />
...
?>
    ...
    <tr class="form-field">
        ...
        <td>
            <input type="text" style="width:400px" name="campaign_cover" id="campaign_cover" class="campaign-cover" value="<?php echo $default_image; ?>">
            <input class="upload_video_button button" name="_campaign_cover" id="_campaign_cover" type="button" value="Select/Upload Image" />
        </td>
    </tr>
    <tr class="form-field">
