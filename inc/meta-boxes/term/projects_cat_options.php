...
?>
    <div class="form-field">
        ...
        <input class="upload_video_button button" name="_add_projects_cover" id="_add_projects_cover" type="button" value="Select/Upload Image" />
...
?>
    ...
    <tr class="form-field">
        ...
        <td>
            <input type="text" style="width:400px" name="projects_cover" id="projects_cover" class="projects-cover" value="<?php echo $default_image; ?>">
            <input class="upload_video_button button" name="_projects_cover" id="_projects_cover" type="button" value="Select/Upload Image" />
        </td>
    </tr>
    <tr class="form-field">
