...
{
    wp_nonce_field(basename(__FILE__), "category_options");
    ...
    <div class="form-field">
        ...
        <input class="upload_video_button button" name="_add_category_cover" id="_add_category_cover" type="button"
...
function category_edit_cover_field($term)
{
    ...
    <tr class="form-field">
        ...
        <td>
            ...
            <input class="upload_video_button button" name="_category_cover" id="_category_cover" type="button"
                value="Select/Upload Image" />
        </td>
    </tr>
    <tr class="form-field">
