...
function news_slider_vc()
{
	...
	$args = array(
		"name"					=> esc_html__("News Slider", 'DOMAIN'),
		"description"			=> esc_html__("Add News Slider", 'DOMAIN'),
		"base"					=> "news_slider",
		'category'			    => esc_html__('BONYAN', 'DOMAIN'),
		'icon'					=> get_wpb_icon_url('news_slider'),
		'params'				=> array(
			array(
				"type"			=> "textfield",
				"admin_label"	=> false,
				"heading"		=> esc_html__("Header Text", 'text_DOMAIN'),
				"param_name"	=> "news_slider_header_text",
				"value"			=> "",
			...
			array(
				...
				"param_name"	=> "news_slider_cards_count",
				"value"			=> "",
				"description"	=> esc_html__("Type a description to show under the section title.", 'text_DOMAIN'),
			),
			array(
...
add_action('vc_before_init', 'news_slider_vc');
