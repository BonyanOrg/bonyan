        ...
        <form class="zakat-calculator-container custom-widget" onsubmit="isLowerThanNisab(event, this);">
            ...
            <div class="zakat-calculator-inputs">
                ...
                <div class="zakat-calculator-result">
                    ...
                    <button class="user-action-btn primary-btn donation-btn" id="zakat-donation-btn" <?php echo is_user_logged_in() ? 'data-target="givewp-modal"' : 'data-target="donation-modal"'; ?> data-nisab="<?php echo intval($zakat_calc_nisab_value) ?>" data-amount="5" data-giveformid="<?php echo $zakat_calc_form_id ?>">
