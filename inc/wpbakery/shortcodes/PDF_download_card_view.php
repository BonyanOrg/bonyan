    ...
    function pdf_download_card_shortcode($atts)
    {
        ...
        <div class="content-with-info-panel">
            <div class="file-card custom-widget">
                ...
                <div class="file-icon">
                    <img data-src="<?php echo get_template_directory_uri() . '/dist/imgs/report-icon.png'; ?>" alt=""
                        class="lazyload">
                </div>

                <!-- File Name -->
                <h3 class="file-name">
                    <?php echo $pdf_download_card_title ?>
                </h3>
                ...
                <div class="file-cta">
                    ...
                    <a href=" <?php echo $file_link; ?> " target="_blank" download class="primary-btn download-file">
                        <?php _e('Download the file', 'bonyan') ?>
                    </a>
                </div>
            </div>
        </div>
