...
if (!function_exists('archive_program_card_shortcode')) {
    ...
    <?php if (!empty($archive_programs_cards_icon_url)) : ?>
        <img src="<?= esc_url(wp_get_attachment_image_url($archive_programs_cards_icon_url, 'full')); ?>" alt="<?php echo $archive_programs_cards_text ?>">
    <?php else : ?>
