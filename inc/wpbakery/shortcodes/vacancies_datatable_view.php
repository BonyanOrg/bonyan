...
?>
        ...
        <div class="about-us-datatable custom-widget">
            <h2 class="sema-title primary-title"><?php _e('Vacancies', 'sema'); ?></h2>
            ...
            <table id="vacancies-table" class="display nowrap dataTable dtr-inline collapsed" style="width: 100%;" aria-describedby="example_info">
                <thead>
                    <tr>
                        <th><?php _e('Requisition Tittle', 'sema'); ?></th>
                        <th><?php _e('Requisition Number', 'sema'); ?></th>
                        <th><?php _e('Job Location', 'sema'); ?></th>
                        <th><?php _e('Nature Of Working', 'sema'); ?></th>
                        <th><?php _e('Required <br> Number', 'sema'); ?></th>
                        <th><?php _e('Gender', 'sema'); ?></th>
                        <th><?php _e('Type Of Contract', 'sema'); ?></th>
                        <th><?php _e('Start Date', 'sema'); ?></th>
                        <th><?php _e('Submission End Date', 'sema'); ?></th>
                        <th><?php _e('Submission Button', 'sema'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                            <tr <?php echo $is_active ? 'data-status="active"' : ''; ?>>
                                ...
                                <td> <a href="<?php echo get_permalink(get_the_ID()) ?>" class="link-in-table link-as-btn ms-3 ms-md-0"> <?php _e('Submission', 'sema'); ?> </a> </td>
                            </tr>
                    <?php
                        }
                    }
