...
function give_myprefix_validate_recaptcha($valid_data, $data)
{
    ...
    $recaptcha_secret_key = '6Lfq3X8lAAAAAL3d5-P8qwY1DwXYQreq9rxuu_vp'; // Replace with your own key here.
    ...
    <script type="text/javascript">
        jQuery(document).on('give_gateway_loaded', function() {
            grecaptcha.render('give-recaptcha-element', {
                'sitekey': '6Lfq3X8lAAAAAG7TDg8WdWuaYTwN0doKpWv2bJQ9' // Add your own Google API sitekey here.
            });
        });
    </script>
<?php
...
?>
    <div id="give-recaptcha-element" class="g-recaptcha" data-sitekey="6Lfq3X8lAAAAAG7TDg8WdWuaYTwN0doKpWv2bJQ9" style="margin-bottom:1em"></div>
<?php
}
