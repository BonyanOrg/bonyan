...
/* Get User Donations  */
///////////////////////////////
add_action('wp_ajax_get_user_modern_recurring_donations', 'get_user_modern_recurring_donations');
add_action('wp_ajax_nopriv_get_user_modern_recurring_donations', 'get_user_modern_recurring_donations');
function get_user_modern_recurring_donations()
{
    ...
    ob_start();
    get_template_part('template-parts/datatable-modern-recurring-donation', '', array("payments" => $payments));
