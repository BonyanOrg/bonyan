...
function get_infaque_form()
{
    ...
    $infaque_url = "https://bonyan-ngo.web.app/donate-directly/contribution?cause=false&value={$campaignID}{$amount_parameter}&hideOtherCausesCampaigns=yes&header=no-header";
