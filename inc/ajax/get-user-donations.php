...
/* Get User Donations  */
///////////////////////////////
add_action('wp_ajax_get_user_donations', 'get_user_donations');
add_action('wp_ajax_nopriv_get_user_donations', 'get_user_donations');
function get_user_donations()
{
    ...
    ob_start();
    get_template_part('template-parts/datatable-dashboard', '', array("payments" => $payments));
