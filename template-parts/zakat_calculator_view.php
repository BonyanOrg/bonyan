...
<form class="zakat-calculator-container custom-widget" onsubmit="isLowerThanNisab(event, this);">
    ...
    <p class="zakat-calculator-title">Nisab (updated 01 April 2022): Using the value of 87 grams of 24k gold - approximately</p>
    ...
    <div class="zakat-calculator-inputs">
        ...
        <div class="zakat-calculator-result">
            ...
            <p class="mb-3"><?php _e('Ensure that Zakat-Eligible Total', 'bonyan'); ?> <br /><?php _e('Exceeds Nisab', 'bonyan'); ?> - 5300$*</p>

            <button class="primary-btn donation-btn" id="zakat-donation-btn" data-target="bonyan-donation-modal" data-nisab=">" data-amount="00" data-form_id="" data-giveLoop_defaultProgram="">
