...
<section class="campaigns-section py-5">
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-center justify-content-xl-strtch mb-3 ">
            ...
            <a href="#" class="more-btn secondary-outlined-btn ms-3 primary-color hide-from-laptop-up">see more</a>
        </div>
        ...
        <a href="#" class="more-btn secondary-outlined-btn primary-color hide-from-ipad-down mt-3 py-3 h-auto">see more</a>
</section>
<!-- End Campaign Cards -->