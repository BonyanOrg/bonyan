        ...
        <div class="dashboard-tab-content-section donor-giving-stats">
            ...
            <div class="dashboard-content-section-body">
                <div class="donor-giving-stats-values with-padding">
                    ...
                    // ========================================
                    // To enable real stats, simply change this to: $use_real_stats = true;
                    $use_real_stats = false;
                    
                    if ($use_real_stats) {
                        // REAL STATS CODE - Uncomment when ready
                        /*
                        ...
                        */
                        ...
                        // PLACEHOLDER CONTENT - Shows by default (sample stats for styling)
                    ?>
                        <div class="donor-stats-item">
                            <span>12</span>
                            <span><?php _e('Number', 'bonyan'); ?> <br /> <?php _e('of donations', 'bonyan'); ?></span>
        ...
        <div class="dashboard-tab-content-section donations-history">
            <div class="dashboard-content-section-heading py-3">
                <div class="dashboard-content-section-heading-title with-padding">
                    <svg id="Group_3116" data-name="Group 3116" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <path id="Path_10547" data-name="Path 10547" d="M2,11H22v9a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1ZM17,3h4a1,1,0,0,1,1,1V9H2V4A1,1,0,0,1,3,3H7V1H9V3h6V1h2Z" fill="#1877F2" />
                    </svg>
            ...
            <div class="dashboard-content-section-body">
                <div class="donations-history-values with-padding">
                    ...
                    // BACKEND DEVELOPER: EASY SWITCH TO REAL DATA
                    // ========================================
                    // To enable real recent donations, simply change this to: $use_real_recent = true;
                    $use_real_recent = false;
                    
                    if ($use_real_recent && !empty($donor->payment_ids)) {
                        // REAL RECENT DONATIONS CODE - Uncomment when ready
                        /*
                        ...
                        */
                        ...
                        // PLACEHOLDER CONTENT - Shows by default (sample recent donations for styling)
                        $sample_recent_donations = array(
                            array(
                                'id' => 'DON-001',
                                'amount' => '$150.00',
                    ...
                    ?>
                        ...
                        <!-- Sample Recent Donations Table for Styling -->
                        <table id="donation-history-table" class="donation-history-table display nowrap dashboard-datatable dataTable dtr-inline collapsed" style="width: 100%;" aria-describedby="recent donations table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach ($sample_recent_donations as $donation): ?>
                                    <tr>
