                    ...
                    <div class="dashboard-tab-content-section donations-history">
                        ...
                        <div class="dashboard-content-section-body">
                            <div class="with-padding">
                                <p><b><?php _e('Fill the information then choose where you want to send the invitation', 'bonyan'); ?></b></p>
                                <hr>
                            </div>
                            <div class="contribution-details-form custom-inputs with-padding">
                                ...
                                <div class="select-holder">
                                    <label><?php _e('Select Campaign To Contribute*', 'bonyan'); ?></label>
                                    <select name="select_campaign_to_contribute" id="select_campaign_to_contribute">
                                        <option value=""><?php _e('Search For a Campaign', 'bonyan'); ?></option>
                                    </select>
                                </div>

                                <div class="input-holder">
                                    <label for="contribution_value"><?php _e('Contribution Value', 'bonyan'); ?></label>
                                ...
                                <div class="input-holder full-width">
                                    <label for="invitation_message"><?php _e('Invitation Message', 'bonyan'); ?></label>
                            ...
                            <div class="invite-container mt-lg-4 mt-3 mb-3 with-padding">
                                <p><b><?php _e('Invite Via', 'bonyan'); ?></b></p>
                                <div class="invite-btns">
                                    <a href="#" class="invite-btn by-whatsapp" title="<?php _e('Invite by WhatsApp', 'bonyan'); ?>">
                                        <i class="fa-brands fa-whatsapp"></i>
                                    </a>
                                    <a href="#" class="invite-btn by-telegram" title="<?php _e('Invite by Telegram', 'bonyan'); ?>">
                                        <i class="fa-brands fa-telegram"></i>
                                    </a>

                                    <a href="#" class="invite-btn by-facebook" title="<?php _e('Invite by Facebook', 'bonyan'); ?>">
                                        <i class="fa-brands fa-facebook-f"></i>
                                    </a>

                                    <a href="#" class="invite-btn by-twitter" title="<?php _e('Invite by Twitter', 'bonyan'); ?>">
                                        <i class="fa-brands fa-twitter"></i>
                                    </a>

                                    <a href="#" class="invite-btn by-reddit" title="<?php _e('Invite by Reddit', 'bonyan'); ?>">
                                        <i class="fa-brands fa-reddit"></i>
                                    </a>

                                    <a href="#" class="invite-btn by-gmail" title="<?php _e('Invite by Gmail', 'bonyan'); ?>">
                                        <i class="fa-brands fa-google"></i>
                                    </a>

                                    <a href="#" class="invite-btn by-email" title="<?php _e('Invite by Email', 'bonyan'); ?>">
