<?php $sco_show_progress_bar = get_post_meta($post->ID, "sco_show_progress_bar", true);
$give_form_id = get_post_meta($post->ID, "sco_give_form_id", true);
...
<div class="campaign-card">
    ...
    <a href="<?php echo get_permalink($post) ?>" class="card-head campaign-card-head">
        ...
        <div class="campaign-info">
            ...
            <?php $sco_campaign_end_date = get_post_meta($post->ID, "sco_campaign_end_date", true);
            if (!empty($sco_campaign_end_date)) {
                //Convert to date
                $date_str = $sco_campaign_end_date; //Your date
            ...
            <?php if ($sco_show_donors_count == "yes") : ?>
    ...
    if ($sco_show_progress_bar == "yes" && $total_goal > 0) :
    ?>
