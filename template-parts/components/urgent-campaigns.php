...
<div class="container">
    <div class="swiper primary-carousel">
        <div class="swiper-wrapper">
            ...
            $urgent_campaigns = new WP_Query($query_args);
            if ($urgent_campaigns->have_posts()) :
                while ($urgent_campaigns->have_posts()) :
                    $urgent_campaigns->the_post();
                    $give_form_id = get_post_meta($args['post']->ID, "co_give_form_id", true);
                    $co_show_donors_count = get_post_meta($args['post']->ID, "co_show_donors_count", true);
                    $co_show_reaming_time = get_post_meta($args['post']->ID, "co_show_reaming_time", true);
            ...
            ?>
                        <div class="swiper-slide">
                            ...
                            <div class="primary-carousel-item primary-carousel-info">
                                <?php $co_campaign_end_date = get_post_meta($args['post']->ID, "co_campaign_end_date", true);
